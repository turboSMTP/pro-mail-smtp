...
class EmailFormatterService
{
    ...
    private function prepareEmailData($args)
    {
        ...
        $result =  [
            ...
            'from_email' =>  $headers['from_email'] ?? get_option('pro_mail_smtp_from_email', get_option('admin_email')) ,
            'from_name' => $headers['from_name'] ?? get_option('pro_mail_smtp_from_name', get_option('blog_name')),
