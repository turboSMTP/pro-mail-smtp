 ...
 * Description: Enhance email deliverability by connecting WordPress to SMTP providers with automatic failover, logging, advanced routing, and proactive alerts.
 * Version: 1.4.0
 * Author: turbosmtp
...
define('PRO_MAIL_SMTP_VERSION', '1.4.0');
...
function pro_mail_smtp_init() {
    if (class_exists('TurboSMTP\ProMailSMTP\Core\Plugin')) {
        ...
        add_action('admin_notices', function() {
            ...
            echo esc_html__('Pro Mail SMTP Error: Core plugin class not found. Please ensure the plugin files are intact.', 'pro-mail-smtp');
            echo '</p></div>';
        });
    }
}
