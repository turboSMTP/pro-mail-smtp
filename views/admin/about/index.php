...
<div class="wrap">
    ...
    <p class="description"><?php esc_html_e('Learn more about Pro Mail SMTP and discover our other WordPress plugins.', 'pro-mail-smtp'); ?></p>
    ...
    <div class="review-banner">
        ...
        <span class="review-text"><?php esc_html_e('Loving Pro Mail SMTP? Help us spread the word!', 'pro-mail-smtp'); ?></span>
        ...
        <div class="about-section">
            <div class="about-content">
                <div class="about-main">
                    <h2><?php esc_html_e('About Pro Mail SMTP', 'pro-mail-smtp'); ?></h2>
