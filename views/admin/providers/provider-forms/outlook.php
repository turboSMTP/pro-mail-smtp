...
<div class="wizard-step">
    ...
    <p class="description">Note: Ensure your redirect URL is set to <code><?php echo esc_url(\TurboSMTP\ProMailSMTP\Admin\Providers::get_outlook_redirect_uri()); ?></code></p>
